...
namespace Sixeyed.Core.Containers
{
    ...
    public static class Container
    {
        ...
        private static void Initialise()
        {
            ...
            _UnityContainer.AddNewExtension<unity.Interception.Interception>();
            if (ConfigurationManager.GetSection("unity") != null)
            {
                _UnityContainer.CreateChildContainer();
            }
        ...
        public static void Register<T>(Lifetime lifetime)
        {
            ...
            {
                _UnityContainer.RegisterType<T>((ITypeLifetimeManager) GetLifetimeManager(lifetime), new InjectionConstructor());
        ...
        public static void Register<TInterface, TImplementation>(Lifetime lifetime)
        {
            ...
            {
                _UnityContainer.RegisterType(typeof(TInterface), typeof(TImplementation), GetLifetimeManager(lifetime).ToString(),
        ...
        {
            var registration = _UnityContainer.Registrations.FirstOrDefault(e => e.RegisteredType == typeof(T));
